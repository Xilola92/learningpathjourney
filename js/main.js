...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    ...
    de: {
      ...
      about_intro:
        "Diese Website ist ein persönlicher Raum für Reflexion, Lernen und Wachstum.",
    ...
    ru: {
      ...
      about_title: "О сайте",
      about_intro:
        "Этот сайт — личное пространство для размышлений, обучения и роста.",
    ...
    uz: {
      ...
      about_intro:
        "Bu sayt o‘rganish, tafakkur va rivojlanish uchun shaxsiy makon.",
